const hoverEffect = (function(e, t) {
  ...
  return (
    ...
    function(n) {
      function i() {
        for (let e = arguments, t = 0; t < arguments.length; t++)
      ...
      const r = n.parent
      const o = n.displacementImage
      const a = n.image1
      const s = n.image2
      const f = i(n.imagesRatio, 1)
      const d = i(n.intensity1, n.intensity, 1)
      const l = i(n.intensity2, n.intensity, 1)
      const u = i(n.angle, Math.PI / 4)
      const v = i(n.angle1, u)
      const m = i(n.angle2, 3 * -u)
      const c = i(n.speedIn, n.speed, 1.6)
      const p = i(n.speedOut, n.speed, 1.2)
      const g = i(n.hover, !0)
      const h = i(n.easing, Expo.easeOut)
      let y = i(n.video, !1)
      if (r)
        if (a && s && o) {
          const x = new e.Scene()
          const F = new e.OrthographicCamera(
            r.offsetWidth / -2,
            r.offsetWidth / 2,
            r.offsetHeight / 2,
            r.offsetHeight / -2,
          ...
          F.position.z = 1
          const w = new e.WebGLRenderer({ antialias: !1, alpha: !0 })
          w.setPixelRatio(2),
          ...
          const b = new e.PlaneBufferGeometry(r.offsetWidth, r.offsetHeight, 1)
          const D = new e.Mesh(b, C)
          x.add(D),
            g &&
